...
class Section
{
    private static $post_type = 'section';
    ...
    public function render_metabox( $post ) 
    {
        $fields = [
            ...
            [
                ...
                'tag'      => 'select',
                'options'  => [
                    'bg-primary'   => __( 'Синий', 'pf' ),
                    'bg-secondary' => __( 'Серый', 'pf' ),
                    'bg-info'      => __( 'Голубой', 'pf' ),
                    'bg-success'   => __( 'Зеленый', 'pf' ),
                    'bg-warning'   => __( 'Желтый', 'pf' ),
                    'bg-danger'    => __( 'Красный', 'pf' ),
                ],
                'disabled' => false,
